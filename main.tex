...
\begin{rem}
The following differential inequality for the evolving chord-arc profile is scale invariant provided that \(h\) is degree \(-1\) homogeneous (so that \(h(\lambda \gamma) = \lambda^{-1} h(\gamma)\) for a real number \(\lambda \ne 0\).
\end{rem}
...
&\quad + \left[(-1)^{\delta} \sqrt{1-(Z')^2}((-1)^{\xi} + 1) - (Z - x Z') - 2 Z'\arccos(Z')\right] \frac{Lh}{2\pi} .
\end{split}
\]
\end{thm}
...
\begin{split}
\partial_{\tau} \varphi &\geq 4\varphi'' - 4\xi \frac{1-(\varphi')^2}{\varphi} + (-1)^{\delta} \sqrt{1-(\varphi')^2} [(-1)^{\xi} + 1]\frac{Lh}{2\pi} \\
&\quad + \left(\frac{L}{2\pi}\right)^2 \avg{\kappa(\kappa-h)} (\varphi - x \varphi') + \frac{L}{2\pi} \varphi' \int_p^q \kappa(\kappa-h) ds.
\end{split}
\end{equation}
